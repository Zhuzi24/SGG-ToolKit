...
model = dict(
    ...
    neck=dict(
        type='FPN',
        # in_channels=[256, 512, 1024, 2048], # change for swin large
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            ...
            out_channels=256,
            finest_scale=16, ### SSRW   for large
...
# model = dict(
#     roi_head=dict(
#         bbox_head=dict(num_classes=26)))




checkpoint_config = dict(interval=1, save_last=True, max_keep_ckpts=100)
