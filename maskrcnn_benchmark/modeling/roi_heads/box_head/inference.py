...
class PostProcessor(nn.Module):
    ...
    def forward(self, x, boxes, relation_mode=False):
        ...
        class_prob = F.softmax(class_logits, -1) ### 2000,151
        ...
        for i, (prob, boxes_per_img, image_shape) in enumerate(zip(
            ...
            boxlist = self.prepare_boxlist(boxes_per_img, prob, image_shape, class_logits)
        ...
        return nms_features, results, save_id
    ...
    def prepare_boxlist(self, boxes, scores, image_shape, class_logits = None):
        """
    ...
    def filter_results(self, boxlist, num_classes):
        ...
        scores = boxlist.get_field("pred_scores").reshape(-1, num_classes)  #### 2000 151 
