...
def parse_args():
    ...
    return args
    # parser = ArgumentParser()
    # parser.add_argument('--img', default='data/DOTA/test/images/007.png', help='Image file')
    ...
    # parser.add_argument('--out-file', default='demo/result.jpg', help='Path to output file')
    # parser.add_argument(
    #     '--device', default='cuda:0', help='Device used for inference')
    # parser.add_argument(
    #     '--palette',
