...
# from mmrotate.datasets.custom_test import CustomDataset
...
class DOTADataset(CustomDataset):
   ...
   ### 48
    ...
    #CLASSES = ('airplane','boarding_bridge','terminal','apron','taxiway','runway','ship','boat','dock','crane','goods_yard','storehouse','tank','breakwater','chimney','cooling_tower','smoke','vapor','coal_yard')
    # PALETTE = [(255, 0, 0), (189, 183, 107), (0, 255, 0), (165, 42, 42),
    #            (138, 43, 226), (255, 128, 0), (255, 0, 255), (0, 255, 255),
    #            (255, 193, 193), (0, 51, 153), (255, 250, 205), (0, 139, 139),
    #            (255, 255, 0), (147, 116, 116), (0, 0, 255), (128, 0, 128),
    #            (255, 69, 0), (255, 215, 0), (135, 38, 87), (205, 104, 137),
    #             (3, 168, 158), (0, 199, 140), (255, 227, 132), (138, 43, 226),(206, 79, 57),(0, 55, 205)]
