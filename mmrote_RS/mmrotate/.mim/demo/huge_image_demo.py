...
def parse_args():
    ...
    parser.add_argument('--img', default='data/DOTA/test/images/062.png', help='Image file')
    ...
    parser.add_argument('--out-file', default='demo/000.jpg', help='Path to output file')
    parser.add_argument(
        '--patch_sizes',
        type=int,
        nargs='+',
